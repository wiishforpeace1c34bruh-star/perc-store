...
/** The ASCII pill banner with full width ascii text */
const BANNER_ART = [
  '  <span class="pink">⠀⠀⠀⣀⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⡀⠀⠀⠀⠀⠀⠀</span>',
  '  <span class="pink">⠀⢀⣼⣿⣿⣄⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣠⣄⣠⣾⣿⣇⠀⠀⠀⠀⠀⠀</span>',
  '  <span class="pink">⠀⢸⣿⣿⣿⣿⣏⣉⣉⣉⣉⣉⣉⣉⣉⣉⣉⣉⣉⣹⣿⣿⣿⣿⣀⡀⠀⠀⠀⠀</span>',
  '  <span class="pink">⠀⢸⣿⣿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⣿⣿⣿⡇⠰⠿⠇⠀</span>   <span style="font-weight: bold; color: #fff;">##m###m    m####m    ##m####   m#####m</span>',
  ...
  '  <span class="pink">⠀⠀⠀⠀⠀⠀⠀⠀⢀⣾⣿⠿⠿⢿⡿⢷⣤⣤⣤⠿⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀</span>   <span style="font-weight: bold; color: #fff;">###mm##"  "##mmmm#   ##       "##mmmm#</span>',
  '  <span class="pink">⠀⠀⠀⠀⠀⠀⠀⠀⣸⣿⣿⣶⣶⣾⡇⠀⠈⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀</span>   <span style="font-weight: bold; color: #fff;">## """      """""    ""         """"" </span>',
  '  <span class="pink">⠀⠀⠀⠀⠀⠀⠀⠀⣿⣿⣤⣤⣤⣼⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀</span>   <span style="font-weight: bold; color: #fff;">##                                    </span>',
  '  <span class="pink">⠀⠀⠀⠀⠀⠀⠀⢰⣿⣯⣭⣭⣭⣽⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀</span>',
  '  <span class="pink">⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣤⣤⣤⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀</span>',
